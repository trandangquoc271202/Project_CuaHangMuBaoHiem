...
<div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-8">
            <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">ĐỊA CHỈ THANH TOÁN</span>
            </h5>
            <div class="bg-light p-30 mb-5">
                ...
                <form action="/Project_CuaHangMuBaoHiem_war/add_bill" method="post">
                    ...
                    <div class="bg-light p-30">
                        <input type="submit" class="btn btn-block btn-primary font-weight-bold py-3" value="Đặt hàng"
                               style="margin-left: 360px;width: 186px">
                    </div>
                </form>
            </div>
